...
(\cite{Davis1977-iw,Horgan1981-hb}, section X). In the following we
...
(\cite{Binmore2007-uc}, chapter 1, \cite{Osborne2004-ui}, chapter 2). This is quite
...
player, the information is harmful overall. As Paul Almond (\cite*{Almond2010-xn}, chapter 4.5)
says, ``lack of knowledge is
...
recommendation\footnote{If you have
  ...
  two-boxing, whereas only 20\% endorse one-boxing \parencite{Bourget2014-fm}. In fact, Bourget and Chalmers
  (\cite*{Bourget2014-fm}, p. 21, table 11) even shows that philosophers who specialize in decision
theory are especially likely to endorse two-boxing. Defenses of CDT in Newcomb's
problem are given by, e.\,g., Joyce (\cite*{Joyce1999-iv}, chapter 5.1) and
Eells (\cite*{Eells2016-ym}, chapter 8). Some have also argued that
Newcomb's problem cannot occur (\cite{Ledwig2000-vp}, footnote 81; \cite{Binmore2007-uc}, chapter
10).
...
Wedgewood's variation of causal decision theory~\citeyear{Wedgwood2013-mt}.\footnote{Many decision
  ...
  (see, e.\,g. \cite{Lewis1981-ct}; \cite{Hajek2006-me}, page 19; \cite{Weirich2016-gq}, chapter
  2.3; \cite{Pearl2009-xn}, chapter 4).}
...
\begin{figure}
    \centering
    \includegraphics[width=3.46217in,height=2.59375in]{figs/precommitment-causal-graph.pdf}
...
(\cite{Yudkowsky2010-ky}, chapter 2; \cite{Soares2015-is}, chapter 3; \cite{Meacham2010-pk}).
...
(\cite{Hintze2014-ha}, chapter 2.2):
...
news (assuming you correlate with the other agents).\footnote{Similar
  ...
  (\cite{Drescher2006-ky}, chapter 6.2), retribution
  (\cite{Drescher2006-ky}, chapter 7.3.1) and
  \href{https://wiki.lesswrong.com/wiki/Parfit\%27s_hitchhiker}{Parfit's
  hitchhiker} (\cite{Parfit1984-ne}, chapter 1.3).}
...
Armstrong (\cite*{Armstrong2011-sz}, section 3.1.2) and
Drescher (\cite*{Drescher2006-ky}, chapter 6.2).\footnote{Also note that
  updateless behavior
...
justification for updatelessness as discussed by Meacham \citeyear{Meacham2010-pk}, Fallenstein on~\href{http://lesswrong.com/lw/22m/selfmodification_is_the_correct_justification_for/}{LessWrong} and myself in a
\href{https://casparoesterheld.com/2016/11/21/thoughts-on-updatelessnes/}{blog post}
\parencite[cf.][]{Ahmed2012-ue}.
...
induction} (\cite{Soares2014-hg}, section 2.1; \cite{Soares2015-hu}) and
...
(cf. \cite{Ahmed2014-ec}, chapter 4; \cite{Almond2010-xn}, chapter 2.8).
...
(cf. \cite{Drescher2006-ky}, page 298f.).
...
(e.\,g. \cite{Nozick1969-op}, page 135). In particular, reasoning from
correlation seems to fail in so-called \emph{medical Newcomb problems}.
An example is Yudkowsky's chewing gum
problem (\cite*{Yudkowsky2010-ky}, section 1.2), which he describes as follows:
...
(\cite{Gibbard1978-nw}, section 5; \cite{Eells2016-ym}, chapter 4), the Smoking lesion
(\cite{Eells2016-ym}, chapter 4), and the Psychopath button
(\cite{Egan2007-ey}, section 3).
\begin{figure}
    \centering
    \includegraphics[width=1.95625in,height=2.48452in]{figs/causal-graph-CGTA.pdf}
...
include Spohn's variation of CDT (\cite*{Spohn2003-zf}; \cite*{Spohn2005-tm}, section 2;
\cite*{Spohn2012-fo}) and Yudkowsky's timeless decision theory~\citeyear{Yudkowsky2010-ky}.

\begin{figure}
    \centering
    \includegraphics[width=4.1in]{figs/two-types.pdf}
...
(see \cite{Ahmed2014-ec}, section 4.3 for an extensive discission of this argument).

\begin{figure}
    \centering
    \includegraphics[width=4.09792in,height=1.27975in]{figs/tickle-defense.pdf}
...
\emph{individual} agent need not be very large\footnote{Decision
  ...
  (see, e.\,g. \cite{Ahmed2014-ec}, chapter 4.6.3).} (see section
...
(\cite{Soares2014-hg}, section 2.1; \cite{Soares2015-hu}) makes it difficult
...
\begin{figure}
    \centering
    \includegraphics[width=4in]{figs/Superrational-cake-cutting.pdf}
...
weights altogether (\cite{Harsanyi1979-ac}, section 2). Besides the argument of ``equal treatment'', it can
be backed by an
...
normalization (\cite{Isbell1959-ql}; \cite{Hausman1995-ry}, section 3). That
...
\cite{Sen2014-ns}, section 7.3\footnote{Another approach, which I
...
(see \cite{Gibbard1978-nw}; \cite[section 3]{Hintze2014-ha}). Alas, these are
...
MacAskill (\cite*{MacAskill2014-ca}, chapter 3). In particular,
...
describe our own goals\footnote{\label{we-do-not-know-our-utility-function}
  ...
  rationalizations \parencites[pp. 27-51]{Haidt2012-righteous}[pp.
  147-8]{Swidler2013-talk}{Thiele2006-heart}. 
  ``Individuals are often unable to access the causes of their
  moral judgments'' \parencite[p. 368]{Graham2011-mapping}.
  \end{quote}
  Also see \citet[ch. 5]{Muehlhauser2012-ib}.} With the description of their values being
...
were also discussed by, e.\,g., \citet[ch. 5]{Leslie1991-ensuring} and Drescher
(\cite*{Drescher2006-ky}, section 7.3.2):
...
unavailable.\footnote{In the game-theoretical concept of
  ...
  See Leyton-Brown and Shoan (\cite*{Leyton-Brown2008-un}, chapter 3.5) and
  Osborne and Rubinstein (\cite*{Osborne1994-ln}, chapter 3.3) for introductions.}
...
points} (first introduced by Schelling (\cite*{Schelling1960-dn}, chapter 3);
see also Friedman (\cite*{Friedman1994-ie}, chapter I A)) is beneficial to the
...
friendliness (\cite*{Drescher2006-ky}, section 7.2.1).
...
\begin{figure}
    \centering
    \includegraphics[width=1.78646in,height=0.38583in]{figs/mutual-cooperation-graph.pdf}
...
other agent's choice can causally influence my choice, etc.\footnote{Throughout
  ...
  \citeyear{Fehr1999-pd}; Dawkins (\cite*{Dawkins1976-cd}, chapter 12); Taylor \citeyear{Taylor1987-wn}, and
  Buss (\cite*{Buss2015-kp}, chapter 9).
...
\begin{figure}
    \centering
    \includegraphics[width=1.68409in]{figs/circular-cooperation-graph.pdf}
...
Drescher (\cite*{Drescher2006-ky}, pp. 287-292); see
...
\begin{figure}
    \centering
    \includegraphics[width=5.19271in,height=0.49167in]{figs/donation-ladder.pdf}
...
is given by Drescher \citeyear{Drescher2006-ky}, section 7.3.4.
...
the number of rounds is known}\footnote{Even in the iterated prisoner's
  ...
  2/3 of the average game}. A good introduction is given by \citet{Basu2007-Traveler}.
  For further references, see \citet{Basu1994-xk}.}.
...
\citet{Drescher2006-ky}, chapter 7.2.2). If all of this is not the
...
\begin{figure}
    \centering
    \includegraphics[width=3.98958in,height=2.05728in]{figs/donation-DAG.pdf}
...
hypothesis that only their universe exists (cf. \cite{Schmidhuber1997-vd}). In the simple universe,
on the other hand, the multiverse hypothesis may be more complex than the hypothesis that only their
...
other agents (cf. \cite{Drescher2006-ky}, page 290), as we have
seen in section
...
\cite[page 288f]{Drescher2006-ky}). To illustrate this, consider a
one-shot prisoner's dilemma-like situation  (cf. figure \ref{mutual-cooperation-graph}) in which two very similar
...
is higher in expected value than defection (D). Using conditional probabilities, we can formulate this as
$$
...
this universe. If we think about superrational cooperation in this
