...
include Spohn's
\parencite{Spohn2003-zf,Spohn2005-tm,Spohn2012-fo} variation
of CDT and \parencite{Yudkowsky2010-ul} timeless decision
theory.
...
\parencite{Harsanyi1955-ou} aggregation theorem
\parencite{Peterson2017-pa}.\footnote{Interestingly, the
  proof of the aggregation theorem given by
  \parencite{Harsanyi1955-ou} contains an error. However,
...
\parencite{Harsanyi1979-ac} himself proposes -- albeit in
...
\parencite{Sen2014-ns}\footnote{Another approach, which I
...
dilemma}}, adapted from \parencite{Hofstadter1983-az}:
...
(1991, ch. 5)}} and \parencite{Drescher2006-ky}:
...
\parencite{Drescher2006-ky}; see the
...
is given by \parencite{Drescher2006-ky}.
...
\parencite{Drescher2006-ky}). If all of this is not the
...
other agents (cf. \parencite{Drescher2006-ky}), as we have
seen in section
\protect\hyperlink{hierarchies-and-acyclic-graphs}{\emph{Hierarchies
...
\parencite{Drescher2006-ky}). To illustrate this, consider a
